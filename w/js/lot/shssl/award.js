$(function () {
    ...
    var awardTick = function () {
        ...
        $.get('shssl/getShsslAwardData.do', { ajaxhandler: 'GetShsslAwardData', t: Math.random() }, function (data) {
            requireCount += 1;
            ...
            window.setTimeout(awardTick, data.next.awardTimeInterval < 10 ? 2000 : _time);
            timeInterval = 0;
        }, 'json').error(function () {
            if (errorCount < 20) {
    ...
    function loadAwardTimes() {
        $.get('shssl/getShsslAwardTimes.do', { ajaxhandler: 'GetShsslAwardTimes', t: Math.random() }, function (data) {
            //请求到数据后需要做的事情
...
function updateHistoryRecord() {
    $.get('shssl/getNewestRecord.do', { ajaxhandler: 'GetNewestRecord', t: Math.random() }, function (data) {
