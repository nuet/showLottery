...
$(function() {
	...
	function l() {
		$.get("kl8/getkl8AwardTimes.do", {
			ajaxhandler: "Getkl8AwardTimes",
			t: Math.random()
		}, function(b) {
			...
			}, 1e3)), cpNumber = b.current.periodNumber, -1 == i && (i = b.current.periodNumber, luzhuFirstShow(a, i)),
			$(".warnTime #period").html("第" + b.next.periodNumber + "期"), $(" .lot-award .currentAward .period-info .period-leave").html(temp = b.firstPeriod + 179 - cpNumber), h = window.setTimeout(l, b.next.awardTimeInterval < 10 ? 1e4 : b.next.awardTimeInterval + 1e3)
		}, "json").error(function() {
	...
	var h, a = -1,
		...
		isFirst = 0,
		g = function() {
			$.get("kl8/getkl8AwardData.do", {
				ajaxhandler: "Getkl8AwardData",
				t: Math.random()
			}, function(h) {
				var j, k, l, m;
				if (e += 1, h.current.periodNumber != a && -1 != a && (b = 38e3, window.setTimeout(f, 5e3), $(".currentAward .period").css("color", "green"), e = d = 0, hideLotPeriodNumWarn()), 0 != b) {
					for ($(".currentAward .period").html(h.current.periodNumber + " 期  " + h.current.pan + "飞"), j = h.current.awardNumbers.split(","), k = "", l = 0; l < j.length; l++) 10 == l && (k += "<br/>"), k = k + "<span class='no" + j[l] + "'>" + j[l] + "</span>";
