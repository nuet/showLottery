...
<script type="text/javascript" src="js/cookie.js" ></script>
    ...
    <script src="/Public/Home/js/xyftget.js" type="text/JavaScript" />
            ...
            <div class="lot-wrap">
                ...
                <div class="sub_bot_one" id="lot-wrap">
                    <ul class="ullilolo"style=" display: block;cursor: pointer; color: #A85E09; font-size: 14px;">
                        ...
                        <li id="showtext" onClick="showdiv('contentid1','showtext')">
                ...
                <div style="clear:both;display: none;" id="contentid1" class="dataTableKuang">
                ...
                <script id="history_data-tmpl" type="text/template">
                    <table id="history" class="lot-table">
                        ...
                        <it.length
                                ...
                                var lowDate=new Date(Date.parse(row.lotteryTime.replace(
                        /-/g,"/"))).format("hh:mm");
                                ...
                                <row.n8
                                    ...
                                    <row.n7
                                        ...
                                        <tr class="{{=(i+1)%2==0?'even':'odd'}}">
                                            ...
                                            <td><p class="{{=lhStr=='龙'?'pink':'b'}}">{{=lhStr}}</p></td>
                                            <td><p class="{{=lhStr2=='龙'?'pink':'b'}}">{{=lhStr2}}</p></td>
                                            <td><p class="{{=lhStr3=='龙'?'pink':'b'}}">{{=lhStr3}}</p></td>
                                            <td><p class="{{=lhStr4=='龙'?'pink':'b'}}">{{=lhStr4}}</p></td>
                                            <td><p class="{{=lhStr5=='龙'?'pink':'b'}}">{{=lhStr5}}</p></td>
